...
if ($action === 'accept') {
    ...
    // Krijo lidhjen në tabelën friendships (nëse ke një të tillë)
    // P.sh. futja e dyfishtë për miqësinë reciproke
